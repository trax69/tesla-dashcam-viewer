...
// Tesla SEI protobuf schema, inlined so the app needs no fetch() and can run
// directly from file:// (browsers block fetch of local files).
// Mirror of vendor/dashcam.proto (upstream: teslamotors/dashcam) — keep in sync.
const DASHCAM_PROTO = `
syntax = "proto3";
